...
def main(page: Page):
    ...
    # Distribuir las partes aleatoriamente
    ...
    def go_to_predictive_model(event):
        page.go("/FORT")

    button = ElevatedButton("START", on_click=go_to_predictive_model)


    page.horizontal_alignment = "center"
    page.vertical_alignment = "center"
    page.spacing = 30
    page.add(canvas, go_button, again_button,button)

def predictive_model_page(page: Page):
    t = flet.Text(value="Hello, world!")
    page.controls.append(t)
    page.update()

app = flet.app(main,view=flet.WEB_BROWSER)
app.add_route("/", main)  # Ruta principal
app.add_route("/FORT", predictive_model_page)  # Ruta para el modelo predictivo
app.run()
